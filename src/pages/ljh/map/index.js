...
export default class map extends React.Component{
    ...
    changeData =()=>{}
    cp =()=>{
        this.Map.changePosition(this.state.position);
    }
    changeValue=(event)=>{
        ...
        return (
            <div style ={{width:"1340px"}}>
                ...
                <div id="topPanel" className="grayBox">
                    <div class="rightGrayBox" style={{textAlign:"center",width:"100px",fontSize:"18px",color:"#1890ff",float:"left" }}>
                    ...
                    <div class="grayBox omStat">
                        <div class="rightGrayBox" style={{width:"45px",float:"left"}}><img src={i1} width="30px"/></div>
                    ...
                    <div className="grayBox" style ={{width:"300px",height:"230px",marginBottom:"5px"}}>
                        ...
                        <div className={"grayBox"} style ={{width:"280px",height:"120px",border:"#cc6600 solid 1px",margin:"10px"}}>
                            ...
                            <div style ={{width:"270px",marginTop:"5px"}}>
                                <input type="radio" name="s1" value="1" checked/>市场主体名称&nbsp;&nbsp;
                                <input type="radio" name="s1" value="2"/>位置聚焦
